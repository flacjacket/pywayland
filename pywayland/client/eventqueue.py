...
weakkeydict: WeakKeyDictionary[ffi.WlQueue | None, Display] = WeakKeyDictionary()


def _event_queue_destroy(display: Display, cdata: ffi.WlQueue) -> None:
...
class EventQueue:
    ...
    def __init__(self, display: Display) -> None:
        ...
        self._ptr: ffi.WlQueue | None = ffi.gc(ptr, destructor)
